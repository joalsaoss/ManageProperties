    ...
    public class OwnerTests
    {
        ...
        public void Ctor_StringBirthday_lanza_cuando_name_es_nulo_o_blanco(string name)
        {
            var ex = Assert.Throws<BusinessRulesExceptions>(
                () => new Owner(name, address, "photo.png", DateTime.Parse("1990-01-01")));
        ...
        {
            var ex = Assert.Throws<BusinessRulesExceptions>(
                () => new Owner("Juan", address, "photo.png", DateTime.Parse(birthday)));
        ...
        {
            var owner = new Owner("Ana", address, "photo.png", DateTime.Parse("1990-01-01"));
        ...
        public void Ctor_DateOnly_asigna_directo_y_valida()
        {
            ...
            var owner = new Owner("Ana", address, "photo.png", date);
        ...
        {
            var owner = new Owner("  juan   de   la  cruz  ", address, "photo.png", DateTime.Parse("1990-01-01"));
        ...
        {
            var addr = address;
            var owner = new Owner("Ana", addr, "photo.png", DateTime.Parse("1990-01-01"));
